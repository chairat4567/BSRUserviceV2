...
//                    Have space
                    myAlert.normalDialog("Have Space", "Please Fill Every Blink");
                } else {
//                    No Space
                    ...
                    try {
                        ...
                        getUserWhereUserThread.execute(user, myConstant.getUrlGetUserWhere());
                        ...
                        if (json.equals("null")) {
                            ...
                            if (password.equals(jsonObject.getString("Password"))) {
                                ...
                                myAlert.normalDialog("Password False", "Please Password False");
                            }
